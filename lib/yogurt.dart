...
class Yogurt extends StatefulWidget {
  Yogurt({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _YogurtState createState() => _YogurtState();
}
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Padding(
                        ...
                        child: Text("Yogurt-Medium", style: TextStyle(
                            color: Colors.black,
                      ...
                      Padding(
                        ...
                        child: Text('''Yogurt IS GOOD FOR BODY''', style: TextStyle(
                            color: Colors.black,
                            letterSpacing: 0.2,
                            fontWeight: FontWeight.bold,
