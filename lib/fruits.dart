...
import 'package:flutter_grocery_shopping/avocado.dart';
import 'package:flutter_grocery_shopping/papaya.dart';
import 'package:flutter_grocery_shopping/kiwi.dart';
import 'package:flutter_grocery_shopping/mango.dart';
import 'package:flutter_grocery_shopping/strawberry.dart';
                    ...
                    Column(
                      children: <Widget>[
                        GestureDetector(
                          onTap: (){
                            Navigator.push(
                                context, MaterialPageRoute(builder: (context) => Avocado()));},
                          child: _buildFruitCard("Avocado", "assets/avocado.png","₹120", 0xffF7DFB9, 0XffFAF0DA),),
                        ...
                        GestureDetector(
                          ...
                          child: _buildFruitCard("Kiwi", "assets/kiwi.png","₹120", 0xffC4D4A3, 0XffE0E8CF),
                        ),
                        SizedBox(height: 2 * SizeConfig.heightMultiplier,),
                        GestureDetector(
                          onTap: (){
                          ...
                          child: _buildFruitCard("Papaya", "assets/papaya.png","₹150", 0xffF6E475, 0XffF9EFB0),
                        ),
                      ],
                    ),
                    Spacer(),
                    Column(
                      children: <Widget>[
                        ...
                        GestureDetector(
                          ...
                          child: _buildFruitCard("Strawberry", "assets/strawberry.png","₹45", 0xffFFC498, 0XffFDDCC1),
                        ),
                        SizedBox(height: 2 * SizeConfig.heightMultiplier,),
                        GestureDetector(
                          onTap: (){
                          ...
                          child: _buildFruitCard("Mango", "assets/mango.png","₹200", 0xffF0AEAF, 0XffF8C6CA),
                        ),
                        SizedBox(height: 2 * SizeConfig.heightMultiplier,),
                      ],
                    )
