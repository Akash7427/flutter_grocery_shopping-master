...
class Pickels extends StatefulWidget {
  Pickels({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _PickelsState createState() => _PickelsState();
}

class _PickelsState extends State<Pickels> {
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Padding(
                        ...
                        child: Text("Pickels-Medium", style: TextStyle(
                            color: Colors.black,
                      ...
                      Padding(
                        ...
                        child: Text('''Pickels IS GOOD FOR BODY''', style: TextStyle(
                            color: Colors.black,
                            letterSpacing: 0.2,
                            fontWeight: FontWeight.bold,
