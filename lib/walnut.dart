...
class Walnut extends StatefulWidget {
  Walnut({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _WalnutState createState() => _WalnutState();
}
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Padding(
                        ...
                        child: Text("Walnut-Medium", style: TextStyle(
                            color: Colors.black,
                      ...
                      Padding(
                        ...
                        child: Text('''Walnut IS GOOD FOR BODY''', style: TextStyle(
                            color: Colors.black,
                            letterSpacing: 0.2,
                            fontWeight: FontWeight.bold,
