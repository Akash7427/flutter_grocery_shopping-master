                    ...
                    Column(
                      children: <Widget>[
                        GestureDetector(
                          ...
                          child: _buildFruitCard("Onion", "assets/onion.jpg","₹90", 0xffF7DFB9, 0XffFAF0DA),),
                        ...
                        GestureDetector(
                          ...
                          child: _buildFruitCard("Potato", "assets/potato.jpg","₹120", 0xffC4D4A3, 0XffE0E8CF),
                        ),
                        SizedBox(height: 2 * SizeConfig.heightMultiplier,),
                        GestureDetector(
                          onTap: (){
                            Navigator.push(
                                context, MaterialPageRoute(builder: (context) => Pickels()));
                          },
                          child: _buildFruitCard("Pickels", "assets/pickels.jpg","₹150", 0xffF6E475, 0XffF9EFB0),
                        ),
                      ],
                    ),
                    Spacer(),
                    Column(
                      children: <Widget>[
                        ...
                        GestureDetector(
                          ...
                          child: _buildFruitCard("Tomato", "assets/tomato.jpg","₹45", 0xffFFC498, 0XffFDDCC1),
                        ),
                        SizedBox(height: 2 * SizeConfig.heightMultiplier,),
                        GestureDetector(
                          onTap: (){
                            Navigator.push(
                                context, MaterialPageRoute(builder: (context) => Bringels()));},
                          child: _buildFruitCard("Bringels", "assets/bringels.jpg","₹200", 0xffF0AEAF, 0XffF8C6CA),
                        ),
                        SizedBox(height: 2 * SizeConfig.heightMultiplier,),
                      ],
                    )
