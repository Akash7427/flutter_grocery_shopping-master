...
class Milk extends StatefulWidget {
  Milk({Key key, this.title}) : super(key: key);
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Padding(
                        ...
                        child: Text("Milk-Medium", style: TextStyle(
                            color: Colors.black,
                      ...
                      Padding(
                        ...
                        child: Text("1 pc (500ml - 700ml)", style: TextStyle(
                            color: Colors.green,
                            fontWeight: FontWeight.bold,
                      ...
                      Padding(
                        ...
                        child: Text('''MILK IS GOOD FOR BODY''', style: TextStyle(
                            color: Colors.black,
                            letterSpacing: 0.2,
                            fontWeight: FontWeight.bold,
