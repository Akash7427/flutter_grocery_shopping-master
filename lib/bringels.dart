...
class Bringels extends StatefulWidget {
  Bringels({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _BringelsState createState() => _BringelsState();
}

class _BringelsState extends State<Bringels> {
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Padding(
                        ...
                        child: Text("Bringels-Medium", style: TextStyle(
                            color: Colors.black,
                      ...
                      Padding(
                        ...
                        child: Text("1 pc (500gm - 700gm)", style: TextStyle(
                            color: Colors.green,
                            fontWeight: FontWeight.bold,
                      ...
                      Padding(
                        ...
                        child: Text('''Bringels IS GOOD FOR BODY''', style: TextStyle(
                            color: Colors.black,
                            letterSpacing: 0.2,
                            fontWeight: FontWeight.bold,
